...
Proof.
  ...
  (** eq_translation **)
    ...
    + (* The domains *)
      ...
      exists (sHeqTrans qpi (sHeqTransport e (sPair A2' B2' tu2 tv2))).
      destruct hu1' as [[[? ?] ?] ?].
      destruct htu2 as [[[? ?] ?] ?].
      destruct hv1' as [[[? ?] ?] ?].
      destruct htv2 as [[[? ?] ?] ?].
    ...
    + (* The domains *)
      ...
      exists (sHeqTrans qpi (sHeqTransport e (sPi1 A2' B2' tp2))).
      destruct hp1' as [[[? ?] ?] ?].
      destruct htp2 as [[[? ?] ?] ?].
      destruct hA1' as [[[? ?] ?] ?].
      destruct hA2' as [[[? ?] ?] ?].
    ...
    + (* The domains *)
      ...
      exists (sHeqTrans qpi (sHeqTransport e (sPi2 A2' B2' tp2))).
      destruct hp1' as [[[? ?] ?] ?].
      destruct htp2 as [[[? ?] ?] ?].
      destruct hA1' as [[[? ?] ?] ?].
      destruct hA2' as [[[? ?] ?] ?].
